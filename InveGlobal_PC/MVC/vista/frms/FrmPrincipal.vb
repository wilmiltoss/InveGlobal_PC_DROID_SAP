...
#Region "Agregado para android"
    ...
    Private Sub mnu_ajustar_servidor_Click(sender As Object, e As EventArgs) Handles mnu_ajustar_servidor.Click

        If oApControlador.Inventario_OTD.bCerrado = False Then
            'mensaje de notificacion
            oApControlador.notificar_stop("El Inventario esta Abierto! - Debe cerrarlo", "Estado del Inventario")
            'salimos del sub
            Exit Sub
        End If

        oApControlador.Get_servidor_frm.ShowDialog()
    End Sub
