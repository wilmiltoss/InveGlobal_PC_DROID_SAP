...
#Region "ATRIBUTOS"
    ...
    Public frmServidor As frm_servidor

    Private Const UPDATE As String = "UPDATE [LOCALES] SET [ID_SISTEMA] = {1} WHERE [ID_EN_SISTEMA] = {0}"
#End Region
...
#Region "Miembros de ADMbase"
    ...
    Public Overrides Function lAgregar(ByVal oLocalParam As OTDbase) As List(Of Object)
        ...
        Try
            ...
            Dim oLocal As LocalOTD = CType(oLocalParam, LocalOTD)
            ...
            Dim cUpdate As String = String.Format(UPDATE, oLocal.nIdEnSistema, 18)
    ...
    Public Overrides Function lActualizar(ByVal oLocalParam As OTDbase) As List(Of Object)
        Dim NOMBRE_METODO As String = NOMBRE_CLASE + ".lActualizar()"
        ...
        Try
            ...
            Dim cUpdate As String = String.Format(UPDATE, oLocal.nIdEnSistema, 2)
            'ejecutamos la sentencia
            lResultado = _oConector.lEjecutar_sentencia(cUpdate)
            'si se ejecuto correctamente
            If lResultado(0).Equals(1) Then
