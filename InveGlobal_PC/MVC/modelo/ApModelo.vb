...
#Region "ATRIBUTOS"
    ...
    Private __InventarioSoportesADM As InventarioSoportesADM
...
#Region "GETTERS Y SETTERS"
    ...
    ''' <summary>
    ''' Devuelve una instancia del administrador de operaciones sobre la tabla INVENTARIO_SOPORTES
    ''' </summary>
    ''' <returns>Instancia del administrador de operaciones</returns>
    ''' <remarks></remarks>
    Public ReadOnly Property InventarioSoportesADM() As InventarioSoportesADM
        Get
            If __InventarioSoportesADM Is Nothing Then __InventarioSoportesADM = New InventarioSoportesADM(Get_instancia())
            Return __InventarioSoportesADM
